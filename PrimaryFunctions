...
def record_text():
    while(True):
        try:
            ...
            print("Could no request results: {0}".format(e))
        except sr.UnknownValueError:
            print("Having network issue ")
print("Hello I am your smart assistant Malestrom ")
speakText("Hello I am your smart assistant Malestrom ")
